"""
Tools for validating `FLUXNET <https://fluxnet.fluxdata.org>`_ (or other) eddy covariance flux station data. Includes tools for adjusting near surface latent energy and sensible heat fluxes to close the energy balance using multiple methodologies. Other functionalities include data processing, cleaning data using quality control metrics, and visualization.
"""
